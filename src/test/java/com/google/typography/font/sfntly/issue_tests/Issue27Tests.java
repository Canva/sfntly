...
public class Issue27Tests {
  ...
  public void testIssue27() throws Exception {
    ...
    InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream(TestFont.TestFontNames.ROBOTO.getPath());
    Font.Builder fontBuilder = fontFactory.loadFontsForBuilding(is)[0];
