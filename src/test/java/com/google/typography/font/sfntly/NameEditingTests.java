...
public class NameEditingTests {
  ...
  private static final String fontFile = TestFont.TestFontNames.OPENSANS.getPath();
  ...
  public void testChangeOneName() throws Exception {
    ...
    File serializedFontFile = TestFontUtils.serializeFont(font, Files.getFileExtension(fontFile));
  ...
  public void testClearAllNamesAndSetOne() throws Exception {
    ...
    assertNotEquals(0, nameBuilder.builderCount());
    nameBuilder.clear();
